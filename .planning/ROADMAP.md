...
## Fase 1 — Base do MVP
- Configurar o projeto e infraestrutura inicial.
- Implementar autenticação de usuário (login/sessão).
- Criar modelo e CRUD de investimentos.
- Implementar listagem de investimentos.
- Adicionar métricas básicas de total investido e resultado.

**Plans:** 2 plans
Plans:
- [ ] 01-01-PLAN.md — Build Django backend API, SQLite models, JWT auth and investment endpoints
